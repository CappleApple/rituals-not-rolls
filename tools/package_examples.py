...
write(resources/'pack.mcmeta',{'pack':{'pack_format':34,'description':'Rituals Not Rolls: example GUI and sound overrides'}})
...
(datapack/'README.txt').write_text('Install this folder/ZIP in world/datapacks. Sharpness VI costs 300 power instead of 300.1905. Existing affinity IDs are preserved. Run /reload.\n')
(resources/'README.txt').write_text('Install this folder/ZIP in resourcepacks. This includes editable ritual sound events (assets/ritualsnotrolls/sounds.json) with explicit volume/pitch multipliers and a selected-enchantment sprite. Edit the sound entries, or the PNG and matching nine-slice metadata, then use F3+T. Failure pitch choices are separate equally weighted entries. No vanilla texture is overwritten.\n')
