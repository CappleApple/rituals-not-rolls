...
weights={'sharpness': [7, 8, 30, 55, 44, 53, 16], 'smite': [24, 12, 28, 42, 68], 'bane_of_arthropods': [26, 48, 12, 20, 34], 'protection': [22, 10, 40, 64, 36], 'fire_protection': [36, 18, 20, 12, 50], 'blast_protection': [22, 38, 48, 62, 90], 'projectile_protection': [14, 18, 28, 52, 46], 'feather_falling': [30, 62, 40, 54, 72], 'respiration': [12, 28, 48, 60, 90], 'aqua_affinity': [34, 42, 54, 82], 'thorns': [20, 10, 38, 52, 76], 'depth_strider': [24, 32, 12, 40, 72], 'frost_walker': [10, 24, 42, 72, 20], 'binding_curse': [18, 48, 30, 40, 64], 'soul_speed': [22, 34, 58, 78, 115], 'swift_sneak': [14, 85, 32, 42, 56], 'knockback': [42, 38, 24, 58, 76], 'fire_aspect': [22, 40, 28, 52, 46], 'looting': [40, 12, 56, 36, 108, 28], 'sweeping_edge': [10, 18, 34, 28, 66], 'efficiency': [24, 20, 44, 70, 32], 'silk_touch': [24, 46, 30, 38, 54], 'unbreaking': [24, 48, 45, 65, 100], 'fortune': [26, 38, 62, 36, 80], 'power': [12, 22, 16, 42, 54], 'punch': [46, 42, 64, 84, 20], 'flame': [28, 58, 46, 34], 'infinity': [36, 64, 22, 128, 92], 'luck_of_the_sea': [18, 34, 64, 110, 46], 'lure': [18, 26, 38, 56, 44], 'loyalty': [42, 28, 16, 72, 54], 'impaling': [40, 22, 12, 62], 'riptide': [32, 104, 48, 80], 'channeling': [26, 34, 68, 52], 'multishot': [20, 44, 28, 72], 'quick_charge': [38, 22, 18, 62, 40], 'piercing': [24, 12, 52, 82], 'mending': [96, 48, 24, 16, 72], 'vanishing_curse': [32, 46, 70, 96], 'density': [32, 50, 58, 110, 84], 'breach': [18, 36, 58, 96, 88], 'wind_burst': [22, 68, 92, 120, 138]}
# Every default has a distinct effect/color pair; colors are explicit and remain pack-editable.
effects={
 'sharpness':('sweep_attack','AFCFFF'),'smite':('instant_effect','FFE89C'),'bane_of_arthropods':('infested','DFFFAC'),
 'protection':('totem_of_undying','94BCD6'),'fire_protection':('small_flame','FFC078'),'blast_protection':('explosion','C4B4B0'),
 'projectile_protection':('sonic_boom','B8CCD1'),'feather_falling':('cloud','FFF5DC'),'respiration':('bubble_pop','53C9E8'),
 'aqua_affinity':('nautilus','8FF1EB'),'thorns':('enchanted_hit','DAA0E4'),'depth_strider':('splash','9CDFF5'),
 'frost_walker':('snowflake','C9F7FF'),'binding_curse':('raid_omen','CE5E84'),'soul_speed':('soul','B6FFF6'),
 'swift_sneak':('sculk_soul','BEFFF5'),'knockback':('small_gust','EDBE6F'),'fire_aspect':('flame','FF7A22'),
 'looting':('vault_connection','FFF5C9'),'sweeping_edge':('sweep_attack','DAE5FF'),'efficiency':('scrape','E36A54'),
 'silk_touch':('item_cobweb','E2DAF2'),'unbreaking':('wax_on','8FE4FF'),'fortune':('firework','68D99E'),
 'power':('crit','EFA58D'),'punch':('poof','D6C0A0'),'flame':('flame','FFD340'),
 'infinity':('reverse_portal','C782FA'),'luck_of_the_sea':('happy_villager','50DFB9'),'lure':('bubble_pop','75AFDC'),
 'loyalty':('portal','A592E8'),'impaling':('splash','8CE6F5'),'riptide':('gust','A8E8EF'),
 'channeling':('electric_spark','F7F5A0'),'multishot':('firework','C898E7'),'quick_charge':('sculk_charge_pop','C1FFF0'),
 'piercing':('enchanted_hit','BDCFEA'),'mending':('heart','FFFFFF'),'vanishing_curse':('reverse_portal','925BBB'),
 'density':('dust_plume','8C99B5'),'breach':('sonic_boom','D6FFF4'),'wind_burst':('gust','D9FFE6')
}
