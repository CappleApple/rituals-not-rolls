...
DEFAULTS = [
    ...
    ('critical_strike:chance', 5, 'end_rod', 'FFCE67', ['critical_strike:critical'], [('amethyst_shard', 16), ('rabbit_foot', 28), ('golden_carrot', 40), ('quartz', 24), ('emerald', 72)]),
    ...
    ('gouge:grip', 3, 'end_rod', 'C99356', [], [('lead', 24), ('leather', 16), ('honeycomb', 32), ('slime_block', 72), ('tripwire_hook', 16)]),
    ...
    ('notenoughtrials:equity', 1, 'end_rod', 'E4B987', [], [('iron_axe', 24), ('amethyst_shard', 20), ('gold_ingot', 28), ('diamond', 64), ('trial_key', 56)]),
